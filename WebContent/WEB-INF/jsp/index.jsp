...
<head>
    ...
    <script type="text/javascript" src="<%=basePath %>js/js.cookie.js"></script>
    <style>
    	body
		{  
...
<h1 style="text-align: center;font-family: 'Adobe 楷体 Std R';color: #141414">图书管理系统</h1>
...
<div class="panel panel-default" id="login">
    ...
    <div class="panel-body">
        ...
        <div class="checkbox text-left">
            ...
            <a style="margin-left: 100px" href="<%=basePath%>">忘记密码?</a>
        </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.stateCode.trim() == "0") {
                            ...
                            window.location.href="<%=basePath%>admin_main.html";
                            ...
                            $("#info").text("提示:登陆成功，跳转中...");
                            window.location.href="<%=basePath%>reader_main.html";
